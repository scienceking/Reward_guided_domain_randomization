...
class CustomEnv(Env):
    def __init__(self, config: EnvContext):
        ...
        self.E1_range = config.get("E1_range")
        self.E2_range = config.get("E2_range")
        self.E1 = random.uniform(*self.E1_range)
        self.E2 = random.uniform(*self.E2_range)
        ...
        segment_counts = {
            ((0.5, 1), (1000, 1200)): 0, ((1, 1.5), (1000, 1200)): 0,
            ((1.5, 2), (1000, 1200)): 0, ((2, 2.5), (1000, 1200)): 0,
            ((2, 2.5), (1200, 1400)): 0, ((2, 2.5), (1400, 1600)): 0,
            ((2, 2.5), (1600, 1800)): 0, ((2, 2.5), (1800, 2000)): 0, ((2, 2.5), (2000, 2200)): 0,
            ((1.5, 2), (2000, 2200)): 0, ((1, 1.5), (2000, 2200)): 0,
            ((0.5, 1), (2000, 2200)): 0
        }
    ...
    def reward_guided_sampling(self, temperature=1.0):
    ...
    def environment_sampling(self):
        if len(self.E_values) < 300:
            ...
            p = 1  # max(0.1, np.exp(-self.time_count / 2000))
            if random.random() < p:
                self.uniform_sampling()
            else:
